...
import { ConnectionSettings, Auth, AdvancedHttpSettings, ConfigSection, convertLegacyAuthProps } from '@grafana/plugin-ui';
...
export function ConfigEditor(props: Props) {
  ...
  return (
    <>
      ...
      <ConfigSection title="KairosDB Details">
        <InlineField
        ...
        >
          <Switch
            ...
            onChange={(event: React.FormEvent<HTMLInputElement>) => onEnforceScalarSettingChange(event.currentTarget.checked)}
          />
        </InlineField>
        ...
        <InlineField label="Timeout (seconds)" labelWidth={26} tooltip="Request timeout in seconds">
          <Input
